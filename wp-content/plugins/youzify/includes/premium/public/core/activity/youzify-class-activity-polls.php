			...
			<div class="youzify-poll-options">
			    ...
			    <?php
					...
					foreach ( $youzify_poll_element[ 'poll_options' ] as $key => $option ) {
						...
						// Show Poll Option.
						echo '<label class="youzify-poll-item-label">
			                <input type="' . $check_box . '" class="youzify-poll-item-input youzify-current-checked-bg-color ' . $check_box . '" name="youzify_poll_option[]"  value="' . $key . '" ' . $checked . ' ' . $checkbox_disable . '/>' . $poll_img . '<span class="youzify-poll-item-title"> ' . $option['option'] . '</span></label>';
