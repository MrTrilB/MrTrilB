...
Tags: donations, points system, givewp, donation, charity
...
= THREE WAYS TO AWARD POINTS AND BADGES TO YOUR DONORS: = 
...
= DOCUMENTATION =
**[Click here](https://codex.mycred.me/chapter-iii/freebies/mycred-givewp/)** to view the detailed technical documentation. The documentation includes a step-by-step configuration guide and troubleshooting.
...
1. Add Shortcodes
2. Copy Shortcodes
3. myCred Give WP Hook
4. myCred Give WP Hook Settings
5. Donation Frontend - 1
6. Donation Frontend - 2
7. Donation Frontend - 3
8. Thankyou page
9. myCred Give WP Hook
10. myCred Give WP Badge Settings
11. Donation Frontend - 4
12. Notification
13. Log Data
