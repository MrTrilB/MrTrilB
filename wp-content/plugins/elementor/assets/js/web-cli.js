...
var Commands = /*#__PURE__*/function (_CommandsBackwardsCom) {
  ...
  function Commands() {
    ...
    _this.commands = {};
    _this.components = {};
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), 'classes', {
      get: function get() {
        ...
        return (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, $e.commands.commands), $e.commandsInternal.commands), $e.data.commands), $e.routes.commands);
      }
    });
    return _this;
  }
...
(0, _defineProperty3.default)(Commands, "trace", []);
...
var BaseError = /*#__PURE__*/function (_Error) {
  ...
  (0, _createClass2.default)(BaseError, [{
    ...
    value: function notify() {
      _console.default.error((0, _objectSpread2.default)({
...
var CommandCallbackBase = /*#__PURE__*/function (_CommandBase) {
  ...
  var _super = (0, _createSuper2.default)(CommandCallbackBase);
  ...
  (0, _createClass2.default)(CommandData, [{
    ...
    value: function getRequestData() {
      return {
        ...
        endpoint: $e.data.commandToEndpoint(this.command, JSON.parse((0, _stringify.default)(this.args)), this.constructor.getEndpointFormat())
      };
    }
  }, {
    key: "apply",
    ...
    value: function registerCommand(command, context) {
      ...
      if (!instanceType) {
        ...
        context = /*#__PURE__*/function (_CommandCallbackBase) {
          ...
          var _super2 = (0, _createSuper2.default)(context);
