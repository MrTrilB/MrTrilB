<?php $image = goodgame_get_thumbnail('goodgame_post_list_item_small', true, false); ?>
			...
			<div class="content">
				<div>
					...
					<?php
						...
						$post_cats = get_transient('goodgame_post_legend_cat_cache');
						if(empty($post_cats) || empty($post_cats[get_the_ID()]))
						{
							...
							if(!empty($cats))
							{
								...
								set_transient('goodgame_post_legend_cat_cache', $post_cats, 60*60); //1 hour cache
							}
						}
