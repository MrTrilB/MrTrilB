...
$source = goodgame_gs('trending_source');
if($source == 'popular')
{
	$pop_items = GoodGameInstance()->get_popular_posts('weekly');
...
{
	$category = goodgame_gs('trending_category');
...
$items = goodgame_get_post_collection($args, 10);
...
?>
	<div class="trending-posts">
		<div class="tags">
			<div class="trending"><a href="<?php echo esc_url($category_link); ?>"><span><?php echo esc_html(goodgame_gs('trending_title')); ?></span></a></div>
		</div>
