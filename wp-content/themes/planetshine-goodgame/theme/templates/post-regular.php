...
if($post_image_width == 'full_screen')
{
	...
	$outer_wrapper_class = 'container main-content-wrapper hentry post-main-wrapper featured sidebar-' . goodgame_get_sidebar_position();
	$inner_wrapper_class = 'main-content hentry';
}
else
{
	$outer_wrapper_class = 'container main-content-wrapper post-main-wrapper sidebar-' . goodgame_get_sidebar_position();
	$inner_wrapper_class = 'main-content hentry';
	$affix_wrapper_open = '';
	$affix_wrapper_close = '';
}
...
<?php echo goodgame_kses_wrapper_html($affix_wrapper_open); ?>
...
<?php echo $banner = goodgame_get_banner_by_location('post_ad', 'banner-footer'); ?>

<?php echo goodgame_kses_wrapper_html($affix_wrapper_close); ?>