...
$google_font_weights = ':400,700,800,900';

$selected_google_fonts = array(
	'Dosis' => array(
        'slug'		=> 'Dosis',
        'name'		=> 'Dosis',
        'url'		=> 'Dosis' . $google_font_weights,
		'status'	=> _x( 'on', 'Dosis font: on or off', 'planetshine-goodgame' )
    ),
    'Roboto'		=> array(
        'slug'		=> 'Roboto',
        'name'		=> 'Roboto',
        'url'		=> 'Roboto' . $google_font_weights,
		'status'	=> _x( 'on', 'Roboto font: on or off', 'planetshine-goodgame' )
    ),
	'Playfair+Display'  => array(
        'slug'		=> 'Playfair+Display',
        'name'		=> 'Playfair Display',
        'url'		=> 'Playfair Display' . $google_font_weights,
		'status'	=> _x( 'on', 'Playfair Display font: on or off', 'planetshine-goodgame' )
    ),
    'Source+Sans+Pro'  => array(
        'slug'		=> 'Source+Sans+Pro',
        'name'		=> 'Source Sans Pro',
        'url'		=> 'Source Sans Pro'  . $google_font_weights,
		'status'	=> _x( 'on', 'Source Sans Pro font: on or off', 'planetshine-goodgame' )
    ),
	'Raleway' => array(
        'slug'		=> 'Raleway',
        'name'		=> 'Raleway',
        'url'		=> 'Raleway' . $google_font_weights,
		'status'	=> _x( 'on', 'Raleway font: on or off', 'planetshine-goodgame' )
    ),
    'Roboto+Slab'	=> array(
        'slug'		=> 'Roboto+Slab',
        'name'		=> 'Roboto Slab',
        'url'		=> 'Roboto Slab' . $google_font_weights,
		'status'	=> _x( 'on', 'Roboto Slab font: on or off', 'planetshine-goodgame' )
    ),
    'Noto+Sans'		=> array(
        'slug'		=> 'Noto+Sans',
        'name'		=> 'Noto Sans',
        'url'		=> 'Noto Sans' . $google_font_weights,
		'status'	=> _x( 'on', 'Noto Sans font: on or off', 'planetshine-goodgame' )
    ),
    'Average+Sans'  => array(
        'slug'		=> 'Average+Sans',
        'name'		=> 'Average Sans',
        'url'		=> 'Average Sans',
		'status'	=> _x( 'on', 'Average Sans font: on or off', 'planetshine-goodgame' )
    ),
    'Arbutus+Slab'  => array(
        'slug'		=> 'Arbutus+Slab',
        'name'		=> 'Arbutus Slab',
        'url'		=> 'Arbutus Slab' . $google_font_weights,
		'status'	=> _x( 'on', 'Arbutus Slab font: on or off', 'planetshine-goodgame' )
    ),
    'Donegal+One'	=> array(
        'slug'		=> 'Donegal+One',
        'name'		=> 'Donegal One',
        'url'		=> 'DonegalOne' . $google_font_weights,
		'status'	=> _x( 'on', 'Donegal One font: on or off', 'planetshine-goodgame' )
    ),
    'Averia+Serif+Libre'  => array(
        'slug'		=> 'Averia+Serif+Libre',
        'name'		=> 'Averia Serif Libre',
        'url'		=> 'Averia Serif Libre' . $google_font_weights,
		'status'	=> _x( 'on', 'Averia Serif Libre font: on or off', 'planetshine-goodgame' )
    ),
    'Fjalla+One'	=> array(
        'slug'		=> 'Fjalla+One',
        'name'		=> 'Fjalla One',
        'url'		=> 'Fjalla One' . $google_font_weights,
		'status'	=> _x( 'on', 'Fjalla One font: on or off', 'planetshine-goodgame' )
    ),
    'Habibi'		=> array(
        'slug'		=> 'Habibi',
        'name'		=> 'Habibi',
        'url'		=> 'Habibi' . $google_font_weights,
		'status'	=> _x( 'on', 'Habibi font: on or off', 'planetshine-goodgame' )
    ),
    'Alegreya'  => array(
        'slug'		=> 'Alegreya',
        'name'		=> 'Alegreya',
        'url'		=> 'Alegreya' . $google_font_weights,
		'status'	=> _x( 'on', 'Alegreya font: on or off', 'planetshine-goodgame' )
    ),
    'Alegreya+SC'  => array(
        'slug'		=> 'Alegreya+SC',
        'name'		=> 'Alegreya SC',
        'url'		=> 'Alegreya SC' . $google_font_weights,
		'status'	=> _x( 'on', 'Alegreya SC font: on or off', 'planetshine-goodgame' )
    ),
    'Andada'  => array(
        'slug'		=> 'Andada',
        'name'		=> 'Andada',
        'url'		=> 'Andada' . $google_font_weights,
		'status'	=> _x( 'on', 'Andada font: on or off', 'planetshine-goodgame' )
    ),
    'Playfair+Display'  => array(
        'slug'		=> 'Playfair+Display',
        'name'		=> 'Playfair Display',
    ...
    'Domine'  => array(
		...
		'status'	=> _x( 'on', 'Domine font: on or off', 'planetshine-goodgame' )
    ),
    'Vidaloka'  => array(
        'slug'		=> 'Vidaloka',
        'name'		=> 'Vidaloka',
        'url'		=> 'Vidaloka' . $google_font_weights,
		'status'	=> _x( 'on', 'Vidaloka font: on or off', 'planetshine-goodgame' )
    ),
    'Trocchi'  => array(
        'slug'		=> 'Trocchi',
        'name'		=> 'Trocchi',
        'url'		=> 'Trocchi' . $google_font_weights,
		'status'	=> _x( 'on', 'Trocchi font: on or off', 'planetshine-goodgame' )
    ),
    'Vollkorn'  => array(
        'slug'		=> 'Vollkorn',
        'name'		=> 'Vollkorn',
        'url'		=> 'Vollkorn' . $google_font_weights,
		'status'	=> _x( 'on', 'Vollkorn font: on or off', 'planetshine-goodgame' )
    ),
    'Lato'  => array(
        'slug'		=> 'Lato',
        'name'		=> 'Lato',
        'url'		=> 'Lato' . $google_font_weights,
		'status'	=> _x( 'on', 'Lato font: on or off', 'planetshine-goodgame' )
    ),
    'Francois+One'  => array(
        'slug'		=> 'Francois+One',
        'name'		=> 'Francois One',
        'url'		=> 'Francois One' . $google_font_weights,
		'status'	=> _x( 'on', 'Francois One font: on or off', 'planetshine-goodgame' )
    ),
    'Alike'  => array(
        'slug'		=> 'Alike',
        'name'		=> 'Alike',
        'url'		=> 'Alike' . $google_font_weights,
		'status'	=> _x( 'on', 'Alike font: on or off', 'planetshine-goodgame' )
    ),
    'Ultra'  => array(
        'slug' => 'Ultra',
        'name' => 'Ultra',
        'url'  => 'Ultra' . $google_font_weights,
		'status'	=> _x( 'on', 'Ultra font: on or off', 'planetshine-goodgame' )
    ),
    'Arimo'  => array(
        'slug' => 'Arimo',
        'name' => 'Arimo',
        'url'  => 'Arimo' . $google_font_weights,
		'status'	=> _x( 'on', 'Arimo font: on or off', 'planetshine-goodgame' )
    ),
    'Archivo+Black'  => array(
        'slug' => 'Archivo+Black',
        'name' => 'Archivo Black',
        'url'  => 'Archivo Black' . $google_font_weights,
		'status'	=> _x( 'on', 'Archivo Black font: on or off', 'planetshine-goodgame' )
    ),
    'Cutive'  => array(
        'slug' => 'Cutive',
        'name' => 'Cutive',
        'url'  => 'Cutive' . $google_font_weights,
		'status'	=> _x( 'on', 'Cutive font: on or off', 'planetshine-goodgame' )
    ),
    'Days+One' => array(
        'slug'		=> 'Days+One',
        'name'		=> 'Days One',
        'url'		=> 'Days One' . $google_font_weights,
		'status'	=> _x( 'on', 'Days One font: on or off', 'planetshine-goodgame' )
    ),
    'Open+Sans' => array(
        'slug'		=> 'Open+Sans',
        'name'		=> 'Open Sans',
        'url'		=> 'Open Sans' . $google_font_weights,
		'status'	=> _x( 'on', 'Open Sans font: on or off', 'planetshine-goodgame' )
    )
);
?>
