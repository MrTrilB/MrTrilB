...
{
	class GoodGame_Post_List_compact_items extends GoodGame_VC_Block_Base {

		public $shortcode = 'post_list_compact_items';
		public $classname = 'GoodGame_Post_List_compact_items';	//for 5.2 compatibility.
		...
		public function getParams() {
			...
			return array(
				'name'				=> esc_html__('Post list with large items (text on side)', 'planetshine-goodgame'),
				'description'		=> esc_html__('Blog like post list with large items that have text on side. 1/3 to 2/3 width recommended', 'planetshine-goodgame'),
				'base'				=> 'post_list_compact_items',
							...
							<?php foreach($items as $post) : ?>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<?php
											setup_postdata($post);
											get_template_part('theme/templates/post-list-item-compact');
										?>
									</div>
								</div>
	...
	new GoodGame_Post_List_compact_items();
