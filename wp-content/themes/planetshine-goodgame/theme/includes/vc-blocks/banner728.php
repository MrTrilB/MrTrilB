...
{
	class GoodGame_Banner728 extends GoodGame_VC_Block_Base {

		public $shortcode = 'goodgame_banner_728';
		public $classname = 'GoodGame_Banner728';	//for 5.2 compatibility.
		...
		public function getParams() {
			...
			//banners 728x90
			$banners_728x90_data = goodgame_get_active_banners('728x90');
			...
			return array(
				"name" => esc_html__("Banner 728x90", 'planetshine-goodgame'),
				"base" => "goodgame_banner_728",
				"class" => "",
				...
				"params" => array(
					array(
						 ...
						 "description" => esc_html__("Display 728x90 banners. Check more than one to have multiple banners in rotation", 'planetshine-goodgame')
					),
				)
			);
		}
		...
		public static function shortcode($atts = array(), $content = '') {
			...
			if(!empty($banner))
			{
				...
				$banner_data = goodgame_get_banner_by_size_and_slug($banner_id, '728x90');
