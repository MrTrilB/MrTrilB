...
<div class="container-fluid page-title">
    <div class="container">
        <div class="title-wrapper">
            <h1><span><s><?php echo goodgame_archive_title( get_wpml_admin_text_string('blog_title') ); ?></s></span></h1>
        </div>
    </div>
</div>
...
<?php echo $banner = goodgame_get_banner_by_location('blog_ad', 'banner-footer'); ?>
