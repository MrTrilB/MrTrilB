<?php
    ...
    if(!empty($head) && !empty($body))
    {
        ...
        if($view == 'ads_manager')
        {
            $section_key = goodgame_get($_GET, 'section', 'ads_manager');
        }
		elseif($view == 'setup')
		{
        ...
        {
            $section_key = goodgame_get($_GET, 'section', false);
        }
		...
		<div class="main-control-panel-wrapper">
			...
			<div class="main-content-wrapper">
                <div class="main-content view-<?php echo esc_attr($view); ?>">
					...
					<!-- BEGIN .header -->
					<div class="header">
						<h2><?php echo goodgame_gs('theme_name'); ?><span>/ <?php echo esc_html($view_title . $section_title); ?></span></h2>
					<!-- END .header -->
					</div>
