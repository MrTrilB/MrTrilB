        ...
        <?php
            if(!empty($body[$view]))
            {
                foreach($body[$view] as $key => $section)
                {
                    ...
                    {
                        goodgame_output_theme_setting($option);
                    }
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            jQuery('#save').click(function(e){		//option update
                ...
                var nonce = '<?php echo wp_create_nonce('goodgame_save_settings') ?>';
                var data = { action: 'goodgame_save_settings', _ajax_nonce: nonce, data: result};
                ...
                jQuery.ajax({
                    ...
                    traditional: true,
                    dataType: 'json',
                    data: { action: 'goodgame_save_settings', _ajax_nonce: nonce, data: jQuery.param(result) },
