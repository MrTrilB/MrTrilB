<?php
	...
	//custom added fonts
	$extra_fonts = get_option('goodgame_extra_google_fonts', array());
?>
<div class="section-item clearfix google-fonts">

	<div class="all-fonts">
		<h3><?php esc_html_e('All Google fonts', 'planetshine-goodgame'); ?></h3>
	...
	<div class="active-fonts">
		<h3><?php esc_html_e('Selected', 'planetshine-goodgame'); ?></h3>
		<div class="font-list">
			<?php
	...
	<div class="default-fonts">
		<h3><?php esc_html_e('Default', 'planetshine-goodgame'); ?></h3>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
		...
		jQuery('.font-item .move-font').click(function(){
            ...
            var nonce = '<?php echo wp_create_nonce('goodgame_extra_google_fonts') ?>';
            var data = { action: 'goodgame_extra_google_fonts', _ajax_nonce: nonce, data: result};
