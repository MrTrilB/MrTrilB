        ...
        ?>
            <div class="section-item ad clearfix banner-form" id="<?php echo esc_attr($ads_item['slug']); ?>">
                 <form name="<?php echo esc_attr($ads_item['slug']); ?>" class="no-submit no-dependency-checkboxes">
                    <h3><?php echo esc_html($ads_item['title']); ?></h3>
                    <?php if(!empty($ads_item['description'])) { echo '<p>' . $ads_item['description'] .'</p>'; } ?>

                    <?php
                    $ad_data = goodgame_gs($ads_item['slug']);
                    ?>
                    <div class="ad-items">
                        <?php
                        if(!empty($ad_data))
                        {
                            foreach($ad_data as $key => $ad_item)
                            {
                                    ...
                                    $ad_item['ad_type'] == 'banner')
                                {
                                    ...
                                    {
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:0']); ?>"><img src="<?php echo esc_url(goodgame_banner_image_src($ad_item['ad_file:0'])); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:1']); ?>"><img src="<?php echo esc_url(goodgame_banner_image_src($ad_item['ad_file:1'])); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:2']); ?>"><img src="<?php echo esc_url(goodgame_banner_image_src($ad_item['ad_file:2'])); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:3']); ?>"><img src="<?php echo esc_url(goodgame_banner_image_src($ad_item['ad_file:3'])); ?>" alt="ad" /></a><?php
                                    }
                                    else
                                    {
										goodgame_banner_image_src($ad_item['ad_file']);
										?><a href="<?php echo esc_url($ad_item['ad_link']); ?>"><img src="<?php echo esc_url(goodgame_banner_image_src($ad_item['ad_file'])); ?>" alt="ad" /></a><?php
                                    }
                                ...
                                else
                                {
                                    ...
                                    {
                                        ?><a href="#"><img src="#" alt="ad" /></a><?php
                                    }

                                    ?></div><?php
                                }

                                goodgame_output_theme_setting(array(
								...
								goodgame_output_theme_setting(array(
                                    'slug' => $prefix . 'mobile_enabled',
                                    'title' => 'Show on mobile',
                                    'type'  => 'checkbox',
                                    'description' => 'Enable/disable the ad to be visible on mobile devices',
                                    'value' => (!empty($ad_item['mobile_enabled']) ? $ad_item['mobile_enabled'] : 'off')
                                ));
                                ...
                                goodgame_output_theme_setting(array(
                                    ...
                                    'data' => array('banner' => 'Image banner', 'googlead' => 'Google AdSense', 'iframe' => 'Iframe ad', 'shortcode' => 'Ad Shortcode'),
                                ...
                                if($ads_item['slug'] == '150x125')
                                {
                                    goodgame_output_theme_setting(array(
                                        ...
                                        'value' => stripslashes($ad_item['googlead_content:0']),
                                    ...
                                    goodgame_output_theme_setting(array(
                                        ...
                                        'type'  => 'textarea',
                                        'description' => 'Content for the Google AdSense',
                                        'value' => stripslashes($ad_item['googlead_content:1']),
                                        'dependant' => 'ad_type ad_type=[googlead]'
                                    ));
                                    ...
                                    goodgame_output_theme_setting(array(
                                        ...
                                        'type'  => 'textarea',
                                        'description' => 'Content for the Google AdSense',
                                        'value' => stripslashes($ad_item['googlead_content:2']),
                                        'dependant' => 'ad_type ad_type=[googlead]'
                                    ));
                                    ...
                                    goodgame_output_theme_setting(array(
                                        ...
                                        'type'  => 'textarea',
                                        'description' => 'Content for the Google AdSense',
                                        'value' => stripslashes($ad_item['googlead_content:3']),
                                        'dependant' => 'ad_type ad_type=[googlead]'
                                    ));
                                ...
                                else
                                {
                                    goodgame_output_theme_setting(array(
                                        ...
                                        'type'  => 'textarea',
                                        'description' => 'Content for the Google AdSense',
                                        'value' => stripslashes($ad_item['googlead_content']),
                                        'dependant' => 'ad_type ad_type=[googlead]'
                                    ));

									goodgame_output_theme_setting(array(
                                        'slug' => $prefix . 'shortcode',
                                        'title' => 'Ad Shortcode',
                                        'type'  => 'textarea',
                                        'description' => 'Use third party shortcode with this ad system',
                                        'value' => $ad_item['shortcode'],
                                        'dependant' => 'ad_type ad_type=[shortcode]'
                                    ));
    ...
    ?>
        ...
        jQuery(document).ready(function () {
            ...
            jQuery('#save').click(function(){
                ...
                var nonce = '<?php echo wp_create_nonce('goodgame_save_ads') ?>';
                var data = { action: 'goodgame_save_ads', _ajax_nonce: nonce, data: ''};
                var results = '';
        ...
        var global_image_url = '<?php echo site_url() .'/wp-admin/admin-ajax.php'; ?>?action=goodgame_upload_image&_ajax_nonce=<?php echo wp_create_nonce('goodgame_upload_image') ?>';
        </script>
