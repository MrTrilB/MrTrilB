...
Class GoodGame_Settings {
	...
	{
		$this->admin_head = apply_filters('goodgame_setup_admin_head', $this->admin_head);
		$this->admin_body = apply_filters('goodgame_setup_admin_body', $this->admin_body);
		$this->static = apply_filters('goodgame_setup_admin_static', $this->static);
		$this->hidden = apply_filters('goodgame_setup_admin_hidden', $this->hidden);
	}
...
function GOODGAME_SETTINGS_INSTANCE() {
	return GoodGame_Settings::instance();
}
