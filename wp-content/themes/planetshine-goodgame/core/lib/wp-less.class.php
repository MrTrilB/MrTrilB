...
if ( file_exists( __DIR__ . '/vendor/autoload.php' ) ) {
	...
	if ( file_exists( __DIR__ . '/lessc.inc.php' ) ) {
		// load LESS parser
...
if ( ! class_exists( 'wp_less' ) ) {
	...
	class wp_less {
		...
		public function __construct() {
			...
			add_filter( 'style_' . 'loader_src', array( $this, 'parse_stylesheet' ), 100000, 2 );
		...
		public function save_parsed_css( $css_path, $file_contents ) {
			...
			goodgame_wp_file_put_contents( $css_path, $file_contents );
		}
